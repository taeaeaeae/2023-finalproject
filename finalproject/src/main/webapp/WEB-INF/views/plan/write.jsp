					...
					<div class="col-8 map-area">
						<div class="map_wrap">
							<div id="map"
								...
								<ul id="category">
									<li id="AD5" data-order="0"><span
										class="category_bg hotel"></span> 숙소</li>
									<li id="AT4" data-order="1"><span class="category_bg tour"></span>
										관광</li>
									<li id="FD6" data-order="2"><span
										class="category_bg restaurant"></span> 맛집</li>
								...
								<button class="btn btn-primary col-sm-1"
									id="scheduleMarker-toggle" onclick="hideMarkers()">갈 곳</button>
							</div>
						</div>
					</div>
					<!-- KAKAO MAP VIEW 영역 끝-->
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fff2cd2202ebff2b59d4cac25059f6f7&libraries=services"></script>
