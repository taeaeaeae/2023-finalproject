...
<fmt:formatDate value="${ now }" var="version" pattern="yyyyMMddHHss"/>
<html>
<head>
...
<script type="text/javascript" src="/resources/js/planner.js?v=${ version }"></script>
<script type="text/javascript" src="/resources/js/write.js?v=${ version }"></script>
<!-- bootstrap -->
