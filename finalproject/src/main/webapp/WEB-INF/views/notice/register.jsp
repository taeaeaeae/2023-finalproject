  ...
  <div id="main" style="margin-left: 10%; margin-right: 10%;">
    <form method="POST" action="/notice/register" enctype="multipart/form-data">
      ...
      <div class="form-group">
	      ...
	      <textarea name="content" class="form-control" id="exampleTextarea" rows="10"></textarea>
      </div>
      ...
      <fieldset class="form-group">
		  <div class="form-check">
		      ...
		      <label class="form-check-label" for="optionsRadios1"><font style="vertical-align: inherit;"> 상단 고정 </font></label>
	      </div>
	      
	      <div class="form-check">
			<input class="form-check-input" type="radio" name="top" id="optionsRadios2" value="0">
			<label class="form-check-label" for="optionsRadios2"><font style="vertical-align: inherit;"> 상단 비고정 </font></label>
	      </div>		
      </fieldset>
